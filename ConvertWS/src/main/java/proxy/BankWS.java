 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://ws_package/", wsdlLocation = "http://localhost:1961/BankWS?wsdl")
public class BankWS
    extends Service
{
    ...
    private final static QName BANKWS_QNAME = new QName("http://ws_package/", "BankWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1961/BankWS?wsdl");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://ws_package/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws_package/", "BankServicePort"), BankService.class, features);
    }
